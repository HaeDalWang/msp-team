...
- 일정은 월별 조회·편집하며 조직 휴일은 관리자가 직접 등록합니다. 공휴일 자동 동기화나 Zendesk 연동은 제공하지 않습니다.
- 시간외 근무는 실제 경과 시간을 1:1로 적립합니다. 시작·종료 시간은 서버가 계산하며, 종료가 더 이르면 다음 날로 계산합니다. 승인된 적립 시간에서 승인된 휴가 사용 시간을 차감합니다. 사용 신청은 시간 단위(소수 둘째 자리까지), 1일 24시간 이하이며 같은 날짜에 중복 신청할 수 없습니다. 별도 가산 배율·만료 정책은 적용하지 않습니다.
- 초과근무와 휴가 사용은 팀장·관리자가 승인 또는 반려합니다. 본인의 미승인·반려 신청은 삭제 후 다시 등록할 수 있습니다. 잔액 확인과 승인은 하나의 트랜잭션으로 처리합니다. 일정의 휴가 표시와 대체휴가 사용 원장은 별도로 관리합니다.
